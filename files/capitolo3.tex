...
Infine ogni classe che implementa l'interfaccia Node definisce, oltre ai metodi per il recupero delle informazioni conservate, un metodo statico per il controllo dei parametri, in modo tale da impedire la costruzione di nodi con informazioni incompatibili con NetLogo.
