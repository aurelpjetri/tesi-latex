...
% Frontespizio -------------------------------------------------------------------
       \title{Analisi e implementazione di componente Java per la generazione di modelli NetLogo}
       \author{Aurel Pjetri}
...
%  pdfpagemode=FullScreen,%
  plainpages=false,%
  breaklinks,%
  pdftitle={Analisi e implementazione di componente Java per la generazione di modelli NetLogo},%
...
\mainmatter
\include{files/capitolo1}
\include{files/capitolo2}
%\include{files/capitolo3}
%\include{files/capitolo4}
%\include{files/capitolo5}
